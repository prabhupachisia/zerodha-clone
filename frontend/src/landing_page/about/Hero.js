        ...
        <div className='container'>
            ...
            <div className='row p-5 mt-5 border-top text-muted' style={{ lineHeight: '1.8', fontSize: '1.2em' }}>
                <div className='col p-5'>
                    <p>We kick-started operations on the 15th of August, 2010 with the goal ot breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Zerodha, acombination of Zero and "Rodha", the Sanskrit word for  barrier</p>
